...
implements LFXLightListener, LFXLightCollectionListener, LFXNetworkContextListener
{
	private LightArrayAdapter lightListAdapter;
	...
	public interface Callbacks {
		 ...
		 */
		public void onItemSelected(LFXLight light);
	}
...
//      	ml.acquire();
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		LFXLight light = lightListAdapter.getItem(position);
		mCallbacks.onItemSelected(light);
	}
	...
	{	
		...
		lightListAdapter.addAll(allLights);
	}
...
//		FragmentActivity activity = getActivity();
//		if (activity != null) {
//			Toast toast = Toast.makeText( activity, "CONNECTED", Toast.LENGTH_SHORT);
//			toast.show();
//		}
	}
...
//		FragmentActivity activity = getActivity();
//		if (activity != null) {
//			Toast toast = Toast.makeText( activity, "DISCONNECTED", Toast.LENGTH_SHORT);
//			toast.show();
//		}
	}
