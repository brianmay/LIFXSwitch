 ...
 * side-by-side with a list of items in a {@link LightListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link LightDetailFragment}.
 */
public class LightDetailActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			getSupportFragmentManager().beginTransaction()
					.add(R.id.light_detail_container, fragment).commit();
		}
	}
